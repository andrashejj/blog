---
title: "Three Bits Survive the Meeting"
date: "2026-04-21"
slug: "shannon-for-founders"
summary: "I told the same investor story five times in four days. Shannon helped explain why two versions landed and three didn't."
...
The paper is from 1948 and concerns telegraphs and telephones. After five investor meetings, I read it as an explanation of why a true idea can leave one person's mouth and arrive in another person's notes as something else.

I marked the parts that explained where my pitch had leaked.
...
That framing was unforgiving to my deck.
...
The 30-second version of our pitch ("personalised investment advice at scale, without hiring more analysts") lands inside a problem the buyer already recognises, then narrows it. Give me ten minutes and I start adding language until the useful signal disappears.
...
Concepts the buyer has not already indexed (causal knowledge graph, temporal asset overlay, Mastra runtime) deserve the longer codes. Spell them out, give the example, earn the bandwidth.

The common failure mode is the exact inversion. Founders over-explain what the buyer already knows (the *why now* for AI in finance, the regulatory tailwind, the market size) and under-explain the part that makes the company different. Swap the lengths.
...
So I had to choose which three bits to ship. For Motif right now, the set is `[B2B2C wealth intelligence]`, `[causal graph, not RAG/sentiment]`, `[traction plus a regulated path]`.
...
It's also why a good investor-FAQ doc earns its keep fast. You write it once, and it drives down equivocation on the handful of questions you *know* come up on every call. Marginal cost: a weekend. Marginal return: every conversation afterward starting one step closer to yes.
...
That is an ugly sentence when you're the one pitching. Meaning is the whole reason you built the thing. You did not spend two years on the product so it could be reduced to three bits over a rosé.
...
On the train, I opened the deck and removed the fourth bit again. Shannon didn't tell me what to say. He gave me a less flattering estimate of how much would survive the wire.
