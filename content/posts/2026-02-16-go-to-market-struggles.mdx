...
summary: "The B2C-to-B2B2C playbook looks neat on paper. The ugly part is getting someone to sign, not getting them to say the idea is interesting."
...
I keep learning the same GTM lesson in the least efficient way possible: by building something first, then discovering that distribution is where the knives are.

My default move is still to ship B2C first because it's the only way to hear the raw customer voice. Catalin Fetean wrote a nice piece on this [here](https://catalinfetean.substack.com/p/the-founder-led-marketing-playbook). If real people like the app, the engine is probably good enough to reuse.
...
So I've adjusted. Strip the UI, package the engine underneath, and sell it to partners who already have the users I want. In my head this always sounds clean. In reality it means months of polite calls with people who like the idea right up until someone has to sign something.
...
## Still the cleanest way I know

The modular approach is still the most capital-efficient way I know to build. Validate the tech before spending months in a sales cycle. One closed contract changes the company.
