...
summary: "The last post was the diagnosis. This is what to do about AI slop, as one person, as a team, and as a company. None of it is banning the tools."
...
My [last post](/blog/take-anything-seriously) was a rant about AI slop, and a confession that an agent wrote it. This is the part where I stop complaining and say what actually helps.

The principle is the same at every scale: someone has to keep doing the thinking the machine can't be trusted to do, and since that stopped happening by accident, you have to arrange for it on purpose. That doesn't mean banning the tools. The speed is real and I'm not giving it up. It means deciding where a human stays in the loop, and holding that line.
...
The machine can produce the work. It can't be accountable for it, and it can't be trusted to have understood it. Deciding where a human stays responsible for those two things is the actual job now, whether you're one engineer approving a diff or a company rebuilding how it trains juniors.
