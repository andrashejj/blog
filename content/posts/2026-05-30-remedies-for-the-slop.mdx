...
summary: "Banning AI tools is a lazy answer. The real work is deciding where humans still have to understand, review, and own the result."
...
My [last post](/blog/take-anything-seriously) was a rant about AI slop, and a confession that an agent wrote it. Complaining is easy. The harder question is where to put the human back.

The answer is not to ban the tools. The speed is real and I'm not giving it up. The answer is to decide which parts still require a named human who understands the work and can be held to it.
...
Start with the one that sounds obvious and almost nobody honours: own what you ship. "The agent wrote it" is not a defense. If your name is on the PR, you're accountable for every line as if you'd typed it. The model will not be paged at 3am. If you can't explain the change to someone asking hard questions, you're not done.
...
Review against intent as well as correctness. Code that's internally consistent and does the wrong thing sails through every automated check and fails the only one that matters. Someone has to hold the real goal in their head and check the work against it, instead of only confirming the tests are green.
...
The machine can produce the work. It cannot be accountable for it, and it cannot be trusted to have understood it. That part is still yours. Teams that remember this will ship less impressive graphs and fewer mystery systems.
