...
The same problem shows up at every scale: someone has to keep doing the thinking the machine can't be trusted to do. Since that stopped happening by accident, you have to arrange for it on purpose. That doesn't mean banning the tools. The speed is real and I'm not giving it up. It means deciding where a human stays in the loop, and holding that line.
